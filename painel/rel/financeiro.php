	...
	<div style="border-style: solid; font-size: 10px; height: 60px;">
		<table style="width: 100%; border: 0px solid #ccc;">
			<tr>
				...
				<td style="width: 1%; text-align: center; font-size: 11px;">
...
<br>
		...
		<table id="cabecalhotabela" style="border-bottom-style: solid; font-size: 8px; margin-bottom:20px; width: 100%; table-layout: fixed;">
			<thead>
