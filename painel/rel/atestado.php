...
<div style="font-size: 15px;">
	<p style="margin-left:80px">Atesto para os devidos fins que o Sr(a) <b><?php echo $nome_paciente ?></b> portador do CPF nº: </p><?php echo $cpf_paciente ?>, esteve sob cuidados profissionais no dia ___/___/_____, e deverá se afastar de suas atividades pelo período de <b><?php echo $datas ?></b> por motivo de <?php echo $motivo ?></p>
</div>
