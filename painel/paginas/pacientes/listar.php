    ...
    <td>
      ...
      <li class="dropdown head-dpdn2" style="display: inline-block;">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
               <big><i class="fa fa-trash-o text-danger"></i></big></a>

            <ul class="dropdown-menu" style="margin-left:-230px;">
            <li>
            <div class="notification_desc2">
            <p>Confirmar Exclusão? <a href="#" onclick="excluir('{$id}')"><span class
      ...
      <big><a href="#" onclick="mostrar('{$nome}','{$telefone}','{$cpf}''{$endereco}',
      '{$data_nascF}','{$tipo_sanguineo}','{$data_cadF}','{$nome_responsavel}','{$cpf_responsavel}','{$nome_convenio}')" title="Mostrar Dados"><i class="fa fa-info-circle text-primary">         
      </i></a></big>
...
<script type="text/javascript">
   function editar(id, nome, telefone, cpf, endereco, data_nasc, nome_responsavel, cpf_responsavel, convenioo){
      $('#mensagem').text('');
      ...
      $('#data_nasc').val(data_nasc).change();      
      $('#tipo_sanguineo').val(tipo_sanguineo);
      $('#nome_responsavel').val(nome_responsavel).change();
   ...
   function mostrar(nome, telefone, cpf, endereco, data_nasc, nome_responsavel, cpf_responsavel, 
   convenioo, alergia, data_cad){
