...
<body>
	<div class="login">		
		<div class="form">
			<img src="img/logo.png" class="imagem" border-radius:10px>
			<form method="post" action="autenticar.php">
				<input type="email" id="email" name="usuario" placeholder="Seu Email" required>
				<input type="password" name="senha" placeholder="Senha" required>
				<button>Login</button>
				<div style="margin-top: 15px; font-size: 13px; "><a href="#" onclick="recuperar()" style="color:#f8ef9d" title="Recuperar Senha">Recuperar Senha?</a></div>
			</form>	
		</div>
	</div>
</body>
